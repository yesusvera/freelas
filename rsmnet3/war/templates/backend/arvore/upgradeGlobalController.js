function upgradeGlobalController($scope,$http,$routeParams,$location)
{
...
$scope.upgrade = function(){
		...
		$http.get($scope.server("/upgrade_global/Json")).success(function(data){
...
$scope.newPlano = function(plano) {
  	 $http.get($scope.server("/upgrade_global/consulta/"+plano)).success(function(data){
...
$scope.upgradeSalvar = function() {
	...
	$http({
		method  : 'POST',
		url     : $scope.server("/upgrade_global/salvar"),
		data    : dados,  
