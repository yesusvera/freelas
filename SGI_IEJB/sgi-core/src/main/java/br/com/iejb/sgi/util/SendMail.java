...
public class SendMail {
	...
	private static final String USER_NAME_EMAIL = "iejb.desenvolvimento@gmail.com";
	private static final String PASSWORD_EMAIL  = "iejb%2014";
	...
	public void sendMail(String from, String to, String subject, String message) {
		...
		auth = new SimpleAuth (USER_NAME_EMAIL,PASSWORD_EMAIL);
		...
		try {
			 ...
			 */
			tr.connect(mailSMTPServer, USER_NAME_EMAIL, PASSWORD_EMAIL);
	...
	public static void main(String args[]){
		new SendMail().sendMail(USER_NAME_EMAIL, "yesusvera@gmail.com", "IEJB", "TESTES DO IEJB");
	}
}
